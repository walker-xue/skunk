 ...
 * <p>
 * <p>
 * 这个类型重写了 common-lang包的 Validate 类型 自定义 异常类型
 * <p>
 * This class assists in validating arguments. The validation methods are
 * based along the following principles:
 * <ul>
 * <li>An invalid {@code null} argument causes a {@link ValidateNullPointerException}.</li>
 * <li>A non-{@code null} argument causes an {@link ValidateIllegalArgumentException}.</li>
 * <li>An invalid index into an array/collection/map/string causes an {@link ValidateIndexOutOfBoundsException}.</li>
 * </ul>
 *
...
public class Validate {
     ...
     * @throws ValidateIllegalArgumentException if expression is {@code false}
     * @see #isTrue(boolean)
    ...
    public static void isTrue(final boolean expression, final String message, final long value) {
        if (!expression) {
            throw new ValidateIllegalArgumentException(String.format(message, Long.valueOf(value)));
        }
    }
    ...
    public static void isTrue(final boolean expression, final String message, final double value) {
        if (!expression) {
            throw new ValidateIllegalArgumentException(String.format(message, Double.valueOf(value)));
        }
    }
    ...
    public static void isTrue(final boolean expression) {
        if (!expression) {
            throw new ValidateIllegalArgumentException(DEFAULT_IS_TRUE_EX_MESSAGE);
        }
    }
     ...
     * @throws ValidateNullPointerException if the object is {@code null}
     ...
     * @throws ValidateNullPointerException     if the array is {@code null}
     * @throws ValidateIllegalArgumentException if the array is empty
     * @see #notEmpty(Object[])
     */
     ...
     * @throws ValidateNullPointerException     if the collection is {@code null}
     * @throws ValidateIllegalArgumentException if the collection is empty
     * @see #notEmpty(Object[])
     */
     ...
     * @throws ValidateNullPointerException     if the map is {@code null}
     * @throws ValidateIllegalArgumentException if the map is empty
     * @see #notEmpty(Object[])
     */
     ...
     * @throws ValidateNullPointerException     if the character sequence is {@code null}
     * @throws ValidateIllegalArgumentException if the character sequence is empty
     ...
     * @return the validated character sequence (never {@code null} method for chaining)
     * @throws ValidateNullPointerException     if the character sequence is {@code null}
     * @throws ValidateIllegalArgumentException if the character sequence is blank
     ...
     * @throws ValidateNullPointerException      if the array is {@code null}
     * @throws ValidateIndexOutOfBoundsException if the index is invalid
    ...
    public static <T> T[] validIndex(final T[] array, final int index, final String message, final Object... values) {
        ...
        if (index < 0 || index >= array.length) {
            throw new ValidateIndexOutOfBoundsException(String.format(message, values));
        }
        return array;
    }
     ...
     * @throws ValidateIllegalArgumentException if the character sequence does not match the pattern
    ...
    public static void matchesPattern(final CharSequence input, final String pattern) {
        ...
        if (!Pattern.matches(pattern, input)) {
            throw new ValidateIllegalArgumentException(String.format(DEFAULT_MATCHES_PATTERN_EX, input, pattern));
        }
    }
     ...
     * @throws ValidateIllegalArgumentException if the value is not a number
     ...
     *
     * @param value the value to validate
     * @throws ValidateIllegalArgumentException if the value is infinite or {@code NaN}
     ...
     * @throws ValidateIllegalArgumentException if the value falls outside the boundaries
    ...
    public static <T> void inclusiveBetween(final T start, final T end, final Comparable<T> value) {
        ...
        if (value.compareTo(start) < 0 || value.compareTo(end) > 0) {
            throw new ValidateIllegalArgumentException(String.format(DEFAULT_INCLUSIVE_BETWEEN_EX_MESSAGE, value, start, end));
        }
    }
    ...
    public static void inclusiveBetween(final long start, final long end, final long value, final String message) {
        // TODO when breaking BC, consider returning value
        if (value < start || value > end) {
            throw new ValidateIllegalArgumentException(message);
        }
    }
    ...
    public static <T> void exclusiveBetween(final T start, final T end, final Comparable<T> value) {
        // TODO when breaking BC, consider returning value
        if (value.compareTo(start) <= 0 || value.compareTo(end) >= 0) {
            throw new ValidateIllegalArgumentException(String.format(DEFAULT_EXCLUSIVE_BETWEEN_EX_MESSAGE, value, start, end));
        }
    }
     ...
     * @throws ValidateIllegalArgumentException if argument is not of specified class
    ...
    public static void isInstanceOf(final Class<?> type, final Object obj) {
        ...
        if (!type.isInstance(obj)) {
            throw new ValidateIllegalArgumentException(String.format(DEFAULT_IS_INSTANCE_OF_EX_MESSAGE, type.getName(),
     ...
     * @throws ValidateIllegalArgumentException if type argument is not assignable to the specified superType
    ...
    public static void isAssignableFrom(final Class<?> superType, final Class<?> type) {
        ...
        if (!superType.isAssignableFrom(type)) {
            throw new ValidateIllegalArgumentException(String.format(DEFAULT_IS_ASSIGNABLE_EX_MESSAGE, type == null ? "null" : type.getName(), superType.getName()));
        }
    }
     ...
     * @param message   the {@link String#format(String, Object...)} exception message if invalid, not null
     * @param values    the optional values for the formatted exception message, null array not recommended
     * @throws ValidateIllegalArgumentException if argument can not be converted to the specified class
