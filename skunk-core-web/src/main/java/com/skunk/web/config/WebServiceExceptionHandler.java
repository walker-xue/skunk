...
import com.skunk.core.exception.BusinessException;
import com.skunk.core.exception.NotFoundResourceException;
 ...
 */
@Slf4j
public abstract class WebServiceExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = {
        ValidateIllegalArgumentException.class,
        ValidateIndexOutOfBoundsException.class,
        ValidateNullPointerException.class,
